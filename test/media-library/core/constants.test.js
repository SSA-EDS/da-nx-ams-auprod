...
describe('constants - environment resolution', () => {
  describe('resolveDaOrigin', () => {
    ...
    it('returns prod origin by default', () => {
      const location = {
        href: 'https://ent-da.live/apps/media-library',
        origin: 'https://ent-da.live',
      };

      const result = resolveDaOrigin(location);
      expect(result).to.equal('https://admin.ent-da.live');
    });

    it('persists ?da-admin=stage to localStorage', () => {
      const location = {
        href: 'https://ent-da.live/apps/media-library?da-admin=stage',
        origin: 'https://ent-da.live',
      };
      ...
      expect(result).to.equal('https://stage-admin.ent-da.live');
    });

    it('persists ?da-admin=local to localStorage', () => {
      const location = {
        href: 'https://ent-da.live/apps/media-library?da-admin=local',
        origin: 'https://ent-da.live',
      };
    ...
    it('clears localStorage when ?da-admin=reset', () => {
      ...
      const location = {
        href: 'https://ent-da.live/apps/media-library?da-admin=reset',
        origin: 'https://ent-da.live',
      };
      ...
      expect(result).to.equal('https://admin.ent-da.live'); // Falls back to prod
    });
    ...
    it('replaces .live with .page for ent-da.page origin', () => {
      localStorage.setItem('da-admin', 'stage');

      const location = {
        href: 'https://ent-da.page/apps/media-library',
        origin: 'https://ent-da.page',
      };

      const result = resolveDaOrigin(location);

      expect(result).to.equal('https://stage-admin.ent-da.page');
    });

    it('handles invalid environment gracefully', () => {
      const location = {
        href: 'https://ent-da.live/apps/media-library?da-admin=invalid',
        origin: 'https://ent-da.live',
      };
  ...
  describe('resolveDaEtcOrigin', () => {
    ...
    it('returns local when ?da-etc=local', () => {
      const location = {
        href: 'https://ent-da.live/apps/media-library?da-etc=local',
      };
    ...
    it('returns custom URL when ?da-etc=custom', () => {
      const location = {
        href: 'https://ent-da.live/apps/media-library?da-etc=https://custom-etc.example.com',
      };
