...
const TRUSTED_APPS = [
  'https://main--storefront-tools--adobe-commerce.ent-aem.live/tools/site-creator/site-creator.html',
  'https://main--storefront-tools--adobe-commerce.ent-aem.live/tools/config-generator/config-generator.html',
];
...
function getUrl() {
  ...
  return `https://${ref}--${repo}--${org}.ent-aem.live/${path}.html${search}${hash}`;
}
