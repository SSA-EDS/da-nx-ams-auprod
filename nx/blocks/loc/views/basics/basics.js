...
const MOCK_URLS = '';
// const MOCK_URLS = 'https://main--da-bacom--adobecom.ent-aem.page/drafts/cmillar/loc-test/main-doc';
...
class NxLocBasics extends LitElement {
  ...
  formatUrls(org, site, urls, snapshot) {
    const baseUrl = snapshot ? `${snapshot}--main--${site}--${org}.ent-aem.reviews` : `main--${site}--${org}.ent-aem.page`;
