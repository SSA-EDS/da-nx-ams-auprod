 ...
 * @param {string} context.daOrigin - DA origin (e.g., https://admin.ent-da.live) (REQUIRED)
 * @param {string} context.daEtcOrigin - DA ETC origin for CORS proxy (REQUIRED)
 * @param {string} context.siteToken - Site token for protected .ent-aem.page sites (optional)
