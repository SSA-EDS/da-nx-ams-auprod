...
describe('DA environment constants', () => {
  ...
  it('HLX_ADMIN is admin.ent-aem.page', () => {
    expect(HLX_ADMIN).to.equal('https://admin.ent-aem.page');
  });

  it('AEM_API is api.ent-aem.live', () => {
    expect(AEM_API).to.equal('https://api.ent-aem.live');
  });
