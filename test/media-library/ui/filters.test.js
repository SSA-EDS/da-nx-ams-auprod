...
describe('filters', () => {
  ...
  describe('filterMedia', () => {
    ...
    const sampleData = [
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/image1.png',
        name: 'image1.png',
        displayName: 'Image 1',
        doc: '/docs/page1',
        status: 'referenced',
      ...
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/video1.mp4',
        name: 'video1.mp4',
        displayName: 'Video 1',
        doc: '/docs/page2',
        status: 'referenced',
      ...
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/icon.svg',
        name: 'icon.svg',
        displayName: 'Icon',
        doc: '/docs/page1',
        status: 'referenced',
      ...
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/document.pdf',
        name: 'document.pdf',
      ...
      {
        url: 'https://main--blog--adobe.ent-aem.live/fragments/footer',
        name: 'footer',
      ...
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/unused.png',
        name: 'unused.png',
  ...
  describe('getSearchSuggestions', () => {
    const sampleData = [
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/header-image.png',
      ...
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/footer-image.png',
    ...
    it('limits suggestions to 10 results', () => {
      const largeDataset = Array.from({ length: 50 }, (_, i) => ({
        url: `https://main--blog--adobe.ent-aem.live/media/image${i}.png`,
        name: `image${i}.png`,
        displayName: `Image ${i}`,
        doc: '/docs/page',
        status: 'referenced',
    ...
    it('slash suggestions include folders from original no-doc asset paths', async () => {
      clearProcessDataCache();
      const noDocItem = {
        url: 'https://main--blog--adobe.ent-aem.live/media/assets-deep/file.png',
  ...
  describe('no-doc same-site assets appear in type filters and No References', () => {
    ...
    const data = [
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/ref.png',
        name: 'ref.png',
        doc: '/docs/a',
        status: 'referenced',
        hash: 'hash-ref',
      ...
      {
        url: 'https://main--blog--adobe.ent-aem.live/media/alone.png',
  ...
  describe('folder filter for no-doc delivery assets', () => {
    it('filterMedia with root folder includes unused items that have asset folders', async () => {
      clearProcessDataCache();
      const noDocItem = {
        url: 'https://main--blog--adobe.ent-aem.live/media/deep/file.png',
        originalPath: '/assets/products/ascent-x2/ascent-x2-mood.jpg',
        name: 'file.png',
        doc: '',
        status: 'unused',
    ...
    it('filterMedia with root folder includes root-level no-doc assets', async () => {
      clearProcessDataCache();
      const noDocItem = {
        url: 'https://main--blog--adobe.ent-aem.live/root.png',
    ...
    it('filterMedia folder: query matches no-doc item by original asset path', async () => {
      clearProcessDataCache();
      const noDocItem = {
        url: 'https://main--blog--adobe.ent-aem.live/media/nested/file.png',
        originalPath: '/assets/products/ascent-x2/ascent-x2-mood.jpg',
        name: 'file.png',
        doc: '',
        status: 'unused',
