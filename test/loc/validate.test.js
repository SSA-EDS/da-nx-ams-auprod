  ...
  describe('getImageAltFragmentUrls', () => {
    it('extracts fragment URLs from image alt attributes', () => {
      ...
      const html = `
        <html>
          <body>
            <img alt="https://main--site--adobecom.ent-aem.page/fragments/video#xf | Video description | :play-medium:" />
            <img alt="https://main--site--adobecom.ent-aem.page/fragments/banner#xf | Banner description" />
  ...
  describe('extractFragmentUrls', () => {
    it('extracts fragment URLs from anchors and image alts', () => {
      const html = `
        <html>
          <body>
            <a href="https://main--site--adobecom.ent-aem.page/fragments/header">Header</a>
            <a href="https://main--site--adobecom.ent-aem.page/fragments/footer">Footer</a>
            <img alt="https://main--site--adobecom.ent-aem.page/fragments/video#xf | Video description" />
            <img alt="Regular image description" />
          </body>
        </html>
      `;
      const urls = getFragmentUrls(html);
      expect(urls).to.include('https://main--site--adobecom.ent-aem.page/fragments/header');
      expect(urls).to.include('https://main--site--adobecom.ent-aem.page/fragments/footer');
      expect(urls).to.include('https://main--site--adobecom.ent-aem.page/fragments/video#xf ');
